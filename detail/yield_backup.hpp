...
template<>
struct async_result<fibers::asio::yield_t, void()> :
    public boost::fibers::asio::detail::async_result_base
{
    typedef fibers::asio::detail::yield_handler<void> completion_handler_type;
...
template<typename T>
struct async_result<fibers::asio::yield_t, void(T)> :
    public boost::fibers::asio::detail::async_result_base
{
    typedef fibers::asio::detail::yield_handler<T> completion_handler_type;
...
template<>
struct async_result<fibers::asio::yield_t, void(boost::system::error_code)> :
    public boost::fibers::asio::detail::async_result_base
{
    typedef fibers::asio::detail::yield_handler<void> completion_handler_type;
    typedef void return_type;
...
template<typename T>
struct async_result<fibers::asio::yield_t, void(boost::system::error_code, T)> :
    public boost::fibers::asio::detail::async_result_base
{
    typedef fibers::asio::detail::yield_handler<T> completion_handler_type;
